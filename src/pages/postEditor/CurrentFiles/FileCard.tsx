...
const AmityFileCard = ({ file, handleRemoveFile }: { file: Amity.File<'file'>, handleRemoveFile: () => void }) => {
    ...
    return (
        <Box display="flex" alignItems="center" gap={2} border={1} borderColor="grey.200" borderRadius={1} p={2}>
            ...
            <Box flex={1} ml={2}>
                ...
                <Typography variant="caption" color="textSecondary">{getSizeFormatted(parseInt(file.attributes.size))}</Typography>
            </Box>
